...
function Hero({ onGoToSignup }) {
  return (
    <section className="relative min-h-[100px] overflow-hidden lg:min-h-[700px]">
      {/* Background image */}
      <div
      ...
      {/* Content */}
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-5 py-10 sm:py-24 lg:grid-cols-2 lg:px-8 lg:py-10">
        <div>
